...
<head>
    ...
    <title>Purchasing History | Own Dress</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="c12 text-center mb-3 main-body">
                ...
                ?>
                    ...
                    <div class="col-12 bg-body text-center main-body" style="height: 450px;">
                            ...
                            ?>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-light text-center text-lg-start rounded shadow-lg align-self-center ">
                                            <label class="form-label text-dark fs-6 py-5 text-center"><?php echo $invoice_data["order_id"]; ?></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-2 bg-light text-center text-lg-end align-self-center rounded">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-secondary border border-1 fs-5 rounded mt-5 border-primary" onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>);"><i class="bi bi-info-circle-fill"></i> Feedback</button>
                                                </div>
                                                <div class="col-6 d-grid">
