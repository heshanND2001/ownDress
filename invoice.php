    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 btn-toolbar justify-content-end shadow-lg rounded">
                ...
                <div class="col-12 shadow-lg rounded" id="page">
                    <div class="row">
                        ...
                        <div class="col-6 shadow-lg rounded">
                            <div class="row">
                                ...
                                <div class="col-12 fw-bold text-end">
                                    <span>Kiridigalla,Ibbagamuwa,Kurunagala</span><br />
                                    <span>0718701011</span><br />
                                    <span>heshandanansooriya@gmail.com</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-4 shadow-lg rounded">
                            <div class="row">
                                <div class="col-6">
                        ...
                        <div class="col-12 text-center">
                            <table class="table border border-dark rounded shadow-lg text-center">
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        <td class="bg-secondary text-white fs-3"><?php echo $invoice_data["id"]; ?></td>
                                        <td>
                                            <span class="fw-bold text-dark fw-bolder text-decoration-underline p-2"><?php echo $oid; ?></span><br />
                                            ...
                                            <span class="fw-bold text-dark fw-bold text-center fs-4 p-2"><?php echo $product_data["title"]; ?></span>
                                        </td>
                        ...
                        <div class="col-4 text-center" style="margin-top: -100px;">
                            <span class="fs-1 fw-bold text-success">Have A Nice Day.</span>
                        </div>
                        ...
                        <div class="col-12 border-start border-5 border-primary mt-3 mb-3 rounded" style="background-color: #e7f2ff;">
                            <div class="row">
                                <div class="col-12 mt-3 mb-3 text-center">
                                    ...
                                    <label class="form-label fs-6">You Can Exchange Or Return Items Before 7 Days.</label>
                                </div>
                            </div>
                        </div>
