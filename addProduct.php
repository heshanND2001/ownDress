...
<head>
    <title>Own Dress | addProduct~</title>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="col-12 mb-2">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" cols="100" rows="10" id="desc" placeholder="enter the details your product dress"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-8 mt-3">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="col-12 mb-3">
                                    <input class="form-control" type="text" id="cl" placeholder="Dress Colour"/>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="col-12">
                            ...
                            <div class="col-12 col-lg-4 offset-lg-4 d-grid mb-2 mt-4">
                                <button class="btn btn-primary search-btn mt-1" onclick="addProduct();">Add Product</button>
                            </div>
                        </div>
                    </div>
                </div>
